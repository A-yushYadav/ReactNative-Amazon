...
const LoginScreen = () => {
    ...
    const handleLogin = ()=>{
      const user={
       ...
       axios.post("http://192.168.1.13:8000/login",user)
     // axios.post("http://172.20.10.2:8000/login",user)
  ...
  return (
    <SafeAreaView style={{flex:1,backgroundColor:"white",alignItems:'center'}}>
      ...
      <KeyboardAvoidingView>
        ...
        <Pressable onPress={handleLogin} style={{width:200,backgroundColor:"#FEBE10",borderRadius:5,marginLeft:"auto" ,marginRight:"auto",padding:15}}>
