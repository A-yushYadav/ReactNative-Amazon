    ...
    return (
        <ScrollView style={{ marginTop: 55, flex: 1, backgroundColor: "white" }} showsVerticalScrollIndicator={false}>
            ...
            <View style={{ padding: 10 }}>
                ...
                <Text style={{ color: "#08CED1" }}>Free delivery Tomorrow by 3 PM. Order within 10hrs 30 min</Text>
                <View style={{ flexDirection: "row", marginVertical: 5, alignItems: "center", gap: 5 }}>
                    <Ionicons name="location" size={24} color="black" />
                    <Text style={{ fontSize: 15, fontWeight: "500" }}>Deliver To Ayush - Bangalore 560068</Text>
                </View>
            </View>
