    ...
    <>
      <SafeAreaView style={{ paddingTop: Platform.OS === "android" ? 40 : 0, flex: 1, backgroundColor: "white" }}>
        <ScrollView>
          ...
          <Pressable
            ...
            style={{ flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "#AFEEEE" }}>
          ...
          <Text style={{ padding: 10, fontSize: 18, fontWeight: "bold" }} >Trending Deal Of week</Text>
          <View style={{ flexDirection: "row", alignItems: "center", flexWrap: "wrap" }}>
            {deals.map((item, index) => (
              ...
              } key={index} style={{ flexDirection: "row", alignItems: "center", marginVertical: 10 }} >
                <Image style={{ width: 160, height: 200, resizeMode: "contain" }} source={{ uri: item?.image }} />
              </Pressable>
            ))}
          </View>
      ...
      <BottomModal onBackDropPress={() => setModalVisible(!modalVisible)}
        ...
        <ModalContent style={{ width: "100%", height: 400 }}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {/* already addes address */}
            {addresses?.map((item,index) => (
              <Pressable  onPress={()=> setSelectedAdress(item)} style={{width:130,height:130,borderColor:"#D0D0D0",borderWidth:1,padding:10,justifyContent:"center",alignItems:"center",gap:3,marginRight:15,marginTop:10,backgroundColor:selectedAddress===item ?"#FBCEB1":"white"}}>
                ...
                <Text numberOfLines={1} style={{width:130,fontSize:13,textAlign:"center"}}>India,Bangalore</Text>
              </Pressable>
            ))}
            <Pressable onPress={() => {
              setModalVisible(false);
              navigation.navigate("Address");
            }} style={{ width: 130, height: 130, borderColor: "#D0D0D0", marginTop: 10, borderWidth: 1, padding: 10, justifyContent: "center", alignItems: "center", }}>
          ...
          <View style={{ flexDirection: "column", gap: 7, marginBottom: 30 }}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
              ...
              <Text style={{ color: "#3066b2", fontWeight: "400" }}>Enter an Indian Pincode</Text>
            </View>

            <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
              <Ionicons name="locate-sharp" size={22} color="#0066b2" />
              <Text style={{ color: "#3066b2", fontWeight: "400" }}>Use My Current Location</Text>
            </View>

            <View style={{ flexDirection: "row", alignItems: "center", gap: 5 }}>
              <AntDesign name="earth" size={22} color="#0066b2" />
              <Text style={{ color: "#3066b2", fontWeight: "400" }}>Deliver Outside India</Text>
            </View>
          </View>
        </ModalContent>
      </BottomModal>
